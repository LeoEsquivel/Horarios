...
public class PGAulaDAO implements AulaDAO {
    ...
    @Override
    public void Insertar(Aula p) throws Excepciones {
    ...
    @Override
    public void Modificar(Aula p) throws Excepciones {
        PreparedStatement ps = null;
        try {
    ...
    @Override
    public void Eliminar(Aula p) throws Excepciones {
        PreparedStatement ps = null;
        try{
    ...
    @Override
    public List<Aula> All() throws Excepciones {
        PreparedStatement ps = null;
        ResultSet rs = null;
    ...
    @Override
    public Aula Buscar(String id) throws Excepciones {
        PreparedStatement ps = null;
        ResultSet rs = null;
        Aula a = null;
        try {
